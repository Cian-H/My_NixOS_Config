-- Thanks to lazy.nvim, i can just have this script return a
-- Lua table containing the plugins i want.
return {
    -- Theme
    {
    ...
    { -- Useful plugin to show you pending keybinds.
        ...
        config = function() -- This is the function that runs, AFTER loading
            ...
            require("which-key").register({
                ...
                ["<leader>t"] = { name = "NERD[T]ree", _ = "which_key_ignore" },
            })
        end,
    },
    ...
    -- Telescope is supposedly much better than a file explorer according to
    -- vim fans. Never would've figured these next few plugins out without
    -- the brilliant `kickstart.nvim` teaching repo!
